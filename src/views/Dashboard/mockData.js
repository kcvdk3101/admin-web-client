...
export default {
  ...
  trend: {
    gradient: [colorConfig.light.success],
  },
  products: [
    {
      id: 0,
  ...
  apexPie: {
    options: {
      ...
      colors: [
        colorConfig.light.primary,
        colorConfig.light.secondary,
        colorConfig.light.success,
        colorConfig.light.warning,
      ],
  ...
  apexArea1: {
    options: {
      ...
      colors: [colorConfig.light.secondary],
      fill: {
        type: "solid",
        opacity: 0.3,
      },
  ...
  apexArea2: {
    options: {
      ...
      colors: [colorConfig.light.primary],
      fill: {
        type: "solid",
        opacity: 0.3,
      },
  ...
  apexArea3: {
    options: {
      ...
      colors: [colorConfig.light.warning],
      fill: {
        type: "solid",
        opacity: 0.3,
      },
  ...
  mainApexArea: {
    options: {
      ...
      colors: [colorConfig.light.warning, colorConfig.light.primary, "#f3f5ff"],
      yaxis: {
        axisBorder: {
          show: true,
          color: "#B9B9B980",
