<template>
  <v-container fluid>
    <div class="tables-basic">
      <h1 class="page-title mt-10 mb-6">User Table</h1>
      <v-row>
        <v-col cols="12">
          <v-card class="employee-list mb-1">
            <v-card-title class="pa-6 pb-3">
              ...
              <v-spacer></v-spacer>
              <v-text-field
                v-model="mockData.userTable.search"
            ...
            <v-data-table
              v-model="mockData.userTable.selected"
              :headers="mockData.userTable.headers"
              :items="mockData.userTable.user"
              :search="mockData.userTable.search"
              item-key="name"
              show-select
            >
            </v-data-table>
          ...
          <v-card class="mb-1">
            ...
            <v-simple-table>
              <template v-slot:default>
                ...
                <tbody>
                  <tr v-for="item in mockData.materialUITable" :key="item.name">
